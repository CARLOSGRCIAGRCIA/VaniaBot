...
const createMockUser = (overrides: Partial<User> = {}): User => ({
  ...
  inventory: [],
  achievements: [],
  stats: { hp: 100, maxHp: 100, energy: 100, maxEnergy: 100, stamina: 100, maxStamina: 100, atk: 10, def: 10, str: 10, int: 10, agi: 10, vit: 10, luck: 5, critChance: 5, dodgeChance: 5 },
  pets: [],
  activeQuests: [],
  completedQuests: [],
  activeBuffs: [],
